    ...
    return (
        <>
            ...
            <div className={styles.Wrapper}>
                <p className={styles.back}><Link className={styles.link} to="#"><ArrowLeft size={20} id={styles.backArrow} /> <span className={styles.spn}>Go Back to Lorem's Profile</span></Link></p>
                ...
                <p className={styles.more}>View More From This Collection</p>
                <Nft />
            </div>
        </>
    );
