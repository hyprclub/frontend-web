...
import { getFirestore, getDocs , collection , doc, getDoc, QuerySnapshot } from "firebase/firestore";
                    ...
                    if(QuerySnapshot.exists()){
                        ...
                        .then((snapshotOwner)=>{
                            if(snapshotOwner.exists()){
                                const storageOwnerRef = ref(storage, "users/" + snapshotOwner.id + "/profile.jpg");
                        ...
                        .then((snapshotCreator)=>{
                            if(snapshotCreator.exists()){
                                ...
                                const storageCreatorRef = ref(storage , "users/" + snapshotCreator.id + "/profile.jpg");
                    ...
                    <div className={styles.container}>
                        ...
                        <div className={styles.details}>
                            ...
                            <div className={styles.cost}>
                                <GradBorder className={styles.price} text={` INR ${itemPrice}`} />
