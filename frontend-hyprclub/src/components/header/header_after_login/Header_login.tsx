...
import {
  UPLOADNFT_MODAL_CLOSE_SUCCESS,
  UPLOADNFT_MODAL_OPEN_SUCCESS,
} from "../../../redux/constants/uploadnftmodal";
...
const Header_login = () => {
  ...
  const { clicked_u } = useSelector(
    (state: RootStore) => state.uploadnftModalOpen
  );
  ...
  return (
    <>
      ...
      <div
        ...
        className={clsx(
          styles.uploadModal,
          clicked_u ? styles.show : styles.hide
        )}
      >
        <UploadModals />
      </div>
