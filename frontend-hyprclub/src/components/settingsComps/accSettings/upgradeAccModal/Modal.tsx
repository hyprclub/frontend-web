                    ...
                    <h2 className={styles.gradientTitle}>Upgrade to a Creator Account</h2>
                        ...
                        <div className={styles.step1}>
                            ...
                            <div className={styles.inputs}>
                                <InputField garyBold lableText='INSTAGRAM' typeOfInput='text' placeholder='Enter Link...'/>
                                <InputField garyBold lableText='TWITTER' typeOfInput='text' placeholder='Enter Link...'/>
                                <InputField garyBold lableText='YOUTUBE' typeOfInput='text' placeholder='Enter Link...'/>
                                <InputField garyBold lableText='YOUR PERSONAL WEBSITE' typeOfInput='text' placeholder='Enter Link...'/>
                            </div>
