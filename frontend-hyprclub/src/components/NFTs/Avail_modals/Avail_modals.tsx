        ...
        <>
            <div className={styles.container}>
                <div className={clsx(styles.first_modal, modals.Modal1 ? styles.show : styles.hide)}>
                    <ArrowLeft size={32} weight="bold" className={styles.back} />
                ...
                <div className={clsx(styles.second_modal, modals.Modal2 ? styles.show : styles.hide)}>
                    ...
                    <div className={styles.body}>
                        ...
                        <div className={styles.buttons}>
                            ...
                            <button className={styles.btn}><p className={styles.btn_text} onClick={()=>setModals({Modal1:false, Modal2:false, Modal3:true})}>Yes, avail this perk</p></button>
                        </div>
                    </div>
                </div>
                <div className={clsx(styles.third_modal, modals.Modal3 ? styles.show : styles.hide)}>
                    ...
                    <div className={styles.buttons}>
                        <button className={styles.btn}><p className={styles.btn_text}>Back to my NFT</p></button>
                    </div>
